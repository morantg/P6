 ...
 */
final class Version20190527072009 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figure ADD groupe_id INT NOT NULL, DROP groupe');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figure ADD groupe VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP groupe_id');
    }
}
